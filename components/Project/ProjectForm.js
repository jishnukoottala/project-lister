...
export default function ProjectForm({
  id,
  onUpdateHandler,
  projectData = { workflow: "", projectName: "" },
  isUpdateForm = false,
  updateLoading = false,
  createLoading = false,
}) {
          ...
          <div>
            <div className="mb-5">
              ...
              <button
                ...
                className="hover:text-white border border-solid border-blue-900 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-2.5 text-center inline-flex items-center"
                type="button"
                data-dropdown-toggle="dropdown"
              >
                {status === "" ? "Select Workflow" : workflow}{" "}
                <svg
              ...
              {showDropDown && (
                <div
                  className="block bg-white text-base z-50 list-none divide-y divide-gray-100 rounded shadow my-4"
                  id="dropdown"
                >
                  <ul
